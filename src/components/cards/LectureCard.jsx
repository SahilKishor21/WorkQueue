...
const LectureCard = ({ lecture, index = 0 }) => {
    let isAdmin = false;
    let isUser = false;
    let isHOD = false;
        ...
        >
            ...
            <motion.div variants={contentVariants} initial="hidden" animate="visible" className="relative z-10">
                ...
                <motion.div className="flex items-start space-x-3 mb-4" variants={itemVariants}>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <motion.p 
                            ...
                            variants={itemVariants}
                        >
                            Video Lecture by {lecture.admin}
                        </motion.p>
                    </div>
                </motion.div>
                ...
                <motion.div className="flex space-x-2 mt-4" variants={itemVariants}>
                    <motion.a
                        href={lecture.fileUrl || lecture.filePath}
                        target="_blank"
                ...
                >
                    <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">
                            Format: <span className="font-medium text-gray-700">Video Content</span>
                        </span>
                        <motion.div
